...
for (var [i,b] of sortedBatches.entries()) {
    ...
    var dataObj = {key: b, count: sortedCount[i], percent: percent * 100.0}
...
for (var [i,b] of sortedBatches.entries()) {
    ...
    var dataObj = {key: b, count: sortedCount[i], live, dead, exited}
...
for (var [i,b] of sortedBatches.entries()) {
    ...
    var dataObj = {key: b, count: sortedCount[i], mega, mini, seed, none}
    batchFundingData.push(dataObj)
}


console.log(JSON.stringify(batchFundingData))
